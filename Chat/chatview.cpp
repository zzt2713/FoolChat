...
ChatView::ChatView(QWidget *parent):QWidget(parent),isAppended(false)
{
    ...
    m_pScrollArea = new ElaScrollArea();
    ...
    connect(pVScrollBar, &ElaScrollBar::rangeChanged,this, &ChatView::onVScrollBarMoved);
...
void ChatView::insertItem(QWidget *before, QWidget *item)
{
